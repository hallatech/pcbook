...
// WriteProtobufToJSON writes protocol buffer message to a JSON file
...
// WriteProtobufToBinary writes protocol buffer message to a binary file
...
func ReadProtobufFromBinaryFile(filename string, message proto.Message) error {
	...
	if err != nil {
		return fmt.Errorf("cannot marshal binary to protobuf: %w", err)
	}
	return nil
}
